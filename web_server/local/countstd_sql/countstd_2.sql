...
--
-- Host: 127.0.0.1
-- Generation Time: May 22, 2020 at 05:28 AM
...
CREATE TABLE `monhoc` (
  `id` int(10) NOT NULL,
  `ma_mon` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
  `ten_mon` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `hoc_ky` int(1) NOT NULL,
  `nam_hoc` int(4) NOT NULL,
  `buoi` varchar(2) COLLATE utf8_unicode_ci NOT NULL,
  `so_tin_chi` int(2) DEFAULT NULL,
  `so_tiet` int(3) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `monhoc` (`id`, `ma_mon`, `ten_mon`, `hoc_ky`, `nam_hoc`, `buoi`, `so_tin_chi`, `so_tiet`) VALUES
(1, 'AAAAA', 'AAAAAAAAAAAAAAAAAA', 2, 2222, 'B2', 2, 30),
(3, 'BBBBB', 'BBBBBBBBBBBBBBBBBBB', 2, 2222, 'C5', 3, 33);
