...
CREATE TABLE `monhoc` (
  `ma_mon` char(8) COLLATE utf8_unicode_ci NOT NULL,
  `ten_mon` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `so_buoi` int(4) NOT NULL,
...
INSERT INTO `monhoc` (`ma_mon`, `ten_mon`, `so_buoi`, `hoc_ky`, `nam_hoc`) VALUES
('AAAAA-S2', 'AAAAAAAAAAAAAAAA', 30, 2, 2222),
('BBBBB-S5', 'BBBBBBBBBBBBBBBBBB', 33, 1, 2222);
...
INSERT INTO `sinhvien` (`id`, `mssv`, `ho`, `ten`, `gioi_tinh`, `ma_mon`) VALUES
(5, 'B1234566', 'AAAA', 'AAAAAA', 1, 'AAAAA-S2'),
(6, 'B6666666', 'BBBBBBB', 'BBBBBBBBBBBBB', 0, 'BBBBB-S2');
